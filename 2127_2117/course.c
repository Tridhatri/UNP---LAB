...
// function to creating a new course using course structure
...
// function to add a new course whenever initial database is commanded
...
// function to add a new course to an existing database
...
// function to modify an existing student's marks of a particular course
